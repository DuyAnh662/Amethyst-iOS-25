**All the new versions of Minecraft work as of right now, including the 26.3 snapshots. Make sure to set your renderer to Mobile Glues! Vulkan is currently broken, but keyboard is fixed. If you want/need to use Vulkan, use release 1.1.0-experimental, but you won't have keyboard support.**
