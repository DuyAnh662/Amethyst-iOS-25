**All the new versions of Minecraft work as of right now. Make sure to set your renderer to Mobile Glues (OpenGL) or MoltenVK (Vulkan)! If you want to use vulkan, make sure to also change it in options.txt**
